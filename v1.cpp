...
/////******Code to Demostrate friend functions and Reference*******////// 
void printstatus(a &obj){
  obj.name="SuccessfulFriend with new name ";
  obj.num="Successful New Friend with new name";
  cout<<obj.name<<endl;
  cout<<obj.num<<endl;
}
...
while(1)
{
  ...
  cout<<"5.To display o/p of Friend functions \n\t\t\t";
  cout<<"6.Exit";
  cin>>trippy;
  if(trippy==0)
  {
